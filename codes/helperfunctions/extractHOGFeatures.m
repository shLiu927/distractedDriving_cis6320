...
%  coordinates, SURFPoints, KAZEPoints, cornerPoints, MSERRegions,
%  ORBPoints or BRISKPoints. Any scale information associated with the
%  points is ignored. The class of validPoints is the same as the input
%  points.
%
...
% must be real and non-sparse. POINTS can be SURFPoints, KAZEPoints,
% ORBPoints, cornerPoints, MSERRegions, BRISKPoints, int16, uint16, int32,
